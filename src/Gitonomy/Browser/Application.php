...
class Application extends BaseApplication
{
    public function __construct(array $repositories)
    {
        ...
        $this['twig']->addExtension(new GitExtension(array('git/default_theme.html.twig')));
    ...
    public function registerPages()
    {
        ...
        $this->get('/', function (Application $app) {
            return $app['twig']->render('repositories.html.twig');
        })->bind('repositories');
        ...
        $this->get('/{name}', function (Application $app, $name) {
            ...
            return $app['twig']->render('repository_graph.html.twig', array(
                'name'       => $name,
         ...
         * Ajax Log entries
         */
        $this->get('/{name}/ajax-log', function (Request $request, Application $app, $name) {
            if (!isset($app['repositories'][$name])) {
                $app->abort(404, "Repository $name does not exist");
            }
            ...
            return $app['twig']->render('repository_ajaxLog.html.twig', array(
                'name'       => $name,
                'log'        => $log
            ));
        })->bind('repository_ajaxLog');
    }
}
